 ...
 */
public class PoliceSuperWindow extends javax.swing.JFrame {


    public PoliceSuperWindow() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PoliceSuperWindow1 pc = new PoliceSuperWindow1();
        pc.setVisible(true);
//        this.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PoliceSuperWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               new PoliceSuperWindow().setVisible(true); 
